    ...
    <form noValidate onSubmit={handleSubmit} className="mt-10 space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        <button
          ...
          className="btn-lift inline-flex items-center justify-center rounded-full bg-lime px-7 py-3.5 text-sm font-medium text-paper disabled:cursor-not-allowed disabled:opacity-60"
        >
      ...
      <div aria-live="polite" className="text-sm">
        ...
        {status === "success" ? (
          <p className="border border-lime/30 bg-lime-soft px-4 py-3 text-lime-deep">
  ...
  return (
    <div>
      <label htmlFor={id} className="text-sm font-medium text-ink">
        ...
        {required ? (
          <span aria-hidden className="ml-0.5 text-lime">
            *
          </span>
        ) : null}
      </label>
